...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if (AccountDeletionRequest::hasPendingForUser($user)) {
            return response()->json([
                'status' => 'failed',
                'message' => 'Sign-in is disabled while an account deletion request is pending. Contact support if you need help.',
            ], 403);
        }
