@php
    ...
    $adminEmail = $adminUser?->email ?: 'admin@wechirp.test';
    $adminAvatar = '/wechirp-static/images/user/owner.png';
@endphp
...
<div class="relative" x-data="{
    ...
    >
       ...
       <span class="block mr-1 font-medium text-theme-sm">{{ $adminName }}</span>
    ...
    >
        <!-- User Info -->
        <div>
            <span class="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">{{ $adminName }}</span>
            <span class="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">{{ $adminEmail }}</span>
        </div>

        <div class="pt-4 pb-3 border-b border-gray-200 dark:border-gray-800"></div>
