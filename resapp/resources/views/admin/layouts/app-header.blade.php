<header
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/admin" class="xl:hidden">
                <div class="flex items-center gap-2">
                    <img class="dark:hidden" src="/wechirp-static/images/logo/we-chirp-logo_05.svg" alt="WeChirp" width="32"
                        height="32" />
                    <img class="hidden dark:block" src="/wechirp-static/images/logo/we-chirp-logo_05.svg" alt="WeChirp"
                        width="32" height="32" />
                    <span class="text-base font-semibold tracking-tight text-gray-900 dark:text-white">WeChirp</span>
                </div>
            </a>
        ...
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            ...
            <form method="POST" action="{{ route('admin.auth.logout') }}" class="hidden xl:block">
                @csrf
                <button type="submit"
                    class="ml-2 inline-flex h-10 items-center justify-center rounded-lg border border-gray-200 bg-white px-4 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-white/5">
                    Logout
                </button>
            </form>
        </div>
