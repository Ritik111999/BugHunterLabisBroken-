...
@php
    use App\Helpers\WechirpMenuHelper;
    $menuGroups = WechirpMenuHelper::getMenuGroups();
        ...
        <a href="/admin">
            <div class="flex items-center gap-3">
                <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                    class="dark:hidden" src="/wechirp-static/images/logo/we-chirp-logo_05.svg" alt="WeChirp" width="40"
                    height="40" />
                <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                    class="hidden dark:block" src="/wechirp-static/images/logo/we-chirp-logo_05.svg" alt="WeChirp" width="40"
                    height="40" />
                ...
                <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                    src="/wechirp-static/images/logo/we-chirp-logo_05.svg" alt="WeChirp" width="28" height="28" />
            </div>
                                    ...
                                    @if (isset($item['subItems']))
                                        ...
                                        <button @click="toggleSubmenu({{ $groupIndex }}, {{ $itemIndex }})"
                                            ...
                                            <span :class="isSubmenuOpen({{ $groupIndex }}, {{ $itemIndex }}) ?
                                                ...
                                                {!! WechirpMenuHelper::getIconSvg($item['icon']) !!}
                                            </span>
