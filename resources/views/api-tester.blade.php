...
<head>
    ...
    @include('partials.pwa-head', ['pwaAppleTitle' => 'WeChirp API'])
        ...
        <div class="bg-white rounded-xl border p-4 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <label class="text-sm">
                    ...
                    <input id="baseUrl" class="w-full border rounded px-3 py-2 font-mono text-sm" placeholder="http://127.0.0.1:9000" />
                </label>
                <label class="text-sm">
...
<script>
    ...
    function loadDefaults() {
        const baseUrl = localStorage.getItem("tester.baseUrl") || "http://127.0.0.1:9000";
