        ...
        <div
            ...
            <a href="/admin" class="xl:hidden">
                <div class="flex items-center gap-2">
                    <img class="dark:hidden" src="/admin/images/logo/we-chirp-logo_05.svg" alt="WeChirp" width="32"
                        height="32" />
                    <img class="hidden dark:block" src="/admin/images/logo/we-chirp-logo_05.svg" alt="WeChirp"
                        width="32" height="32" />
